    ...
    <div className="not-prose">
      <div className="mb-8">
        <input
          ...
          className="w-full p-4 text-base bg-main hover:bg-muted border border-main rounded-full focus:outline-none font-serif italic placeholder-[rgb(var(--color-text-main))/60]"
