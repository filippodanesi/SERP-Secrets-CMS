    ...
    <div className="not-prose">
      <div className="mb-8">
        <input
          ...
          className="w-full p-4 text-base bg-[rgb(var(--color-bg-main))] border border-gray-200 rounded-lg focus:outline-none font-serif italic placeholder-[rgb(var(--color-text-main))/60]"
